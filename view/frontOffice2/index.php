...
<head>
    ...
    <?php 
    // Vérifier si nous sommes sur la page index.php
    ...
    (function() {
        ...
        // Test pour détecter le mode privé via localStorage
        try {
        ...
        // Test via window.open
        if (!isPrivate) {
            var testWindow = window.open("", "test", "width=1,height=1");
            if (!testWindow) {
                isPrivate = true;
            }
            testWindow.close();
        ...
        // Si mode privé détecté, rediriger
        if (isPrivate) {
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 col-lg-4 d-none d-lg-block">
                                ...
                                <?php if (isset($_SESSION['name'])): ?>
                                                <a href="profile.php">Profil: <?php echo htmlspecialchars($_SESSION['name']); ?></a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <a href="signup.php" class="boxed-btn3">Sign in</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                <h3>Switzerland</h3>
                                <p>Pixel perfect design with awesome contents</p>
                                <a href="#" class="boxed-btn3">sign in</a>
                            </div>
                        </div>
                    </div>
                </div>
