...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // AVERTISSEMENT : Comparaison directe des mots de passe
        // DANGER : Cette méthode est extrêmement risquée et ne doit PAS être utilisée en production
        if ($password !== $client['password']) {
            error_log("Échec de la vérification du mot de passe");
            error_log("Mot de passe fourni : " . $password);
            error_log("Mot de passe en BD : " . $client['password']);
        ...
        $_SESSION['name'] = $client['nom'];

        if ($client['role'] === 'Admin') {
            header("Location: http://localhost/MVC3/view/backOffice/signup2.php");
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form method="POST" onsubmit="return validerFormulaire();">
                ...
                value="<?php echo isset($_POST['password']) ? htmlspecialchars($_POST['password'], ENT_QUOTES) : ''; ?>"><br><br>
                <p id="id3"></p>
            ...
            <p>Vous n'avez pas de compte ? <a href="createaccount.php">Créer un compte</a></p>
            <p>mot de passe oubliée ? <a href="forgetpassword.php">motde passe oubliee</a></p>
            <footer>
        <p>Travelo © 2024</p>
    </footer>
        </div>
